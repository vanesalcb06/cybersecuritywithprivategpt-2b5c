[cybersecuritywithprivategpt-2b5c] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-2b5c] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-2b5c] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37165  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='vanesalcb06'  \-\-env DOCKERUSERNAME='vanesalcb'  \-\-env MQTTUSERNAME='vanesalcb'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   vanesalcb/cybersecuritywithprivategpt-2b5c-amd64 (https://hub.docker.com/r/vanesalcb/cybersecuritywithprivategpt-2b5c-amd64)
...
.. important::
   docker run -d -p 37159:37159 -p 57747:57747 -p 51049:51049 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-2b5c \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2b5c \-\-env GITUSERNAME=vanesalcb06  \-\-env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=37159  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=57747  \-\-env SOLUTIONVIPERVIZPORT=51049 \-\-env DOCKERUSERNAME='vanesalcb' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=37165 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='vanesalcb' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  vanesalcb/cybersecuritywithprivategpt-2b5c-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=51049
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=37159
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - vanesalcb/cybersecuritywithprivategpt-2b5c-amd64
...
It can be accessed by entering: http://localhost:57747
...
.. important::
   http://localhost:51049/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:51049/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:51049/<html file>
...
[cybersecuritywithprivategpt-2b5c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/vanesalcb06/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-2b5c
...
.. important::
   https://cybersecuritywithprivategpt-2b5c.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2b5c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=37159, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33905, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46695, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36927, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38069, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35661, HPDEHOST=127.0.1.1, HPDEPORT=39641, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39523

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9633-cybersecuritywithprivategpt-2b5c,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2b5c, python-preprocess-9994-cybersecuritywithprivategpt-2b5c,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2b5c, python-ai-5717-cybersecuritywithprivategpt-2b5c,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-2b5c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
